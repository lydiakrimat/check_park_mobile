...
class AppConstants {
  ...
  static const String erreurTimeout  = 'Le serveur met trop de temps à répondre. Réessayez.';
  ...
  // Spécifique au AI Service — différent du backend Laravel.
  static const String erreurServiceIA =
      'Impossible de joindre le service IA. '
      'Vérifiez que FastAPI est démarré sur le Mac (port 8080) '
